...
void loop() {
    ...
    if (servoMoved && (currentTime - servoMoveStartTime >= 1000)) {
        ...
        Serial.println("Servo motor eski pozisyonuna döndü (90 derece).");
    }
}
...
if (doc.containsKey("steerleft")) {
    ...
    if (steerLeft == 1) {
        // Servo motoru sola 90 derece döndür ve sonra geri getir
        servoAngle = 0; // Sol maksimum 0 derece
        myServo.write(servoAngle);
        Serial.println("Servo motor sola 90 derece döndü.");
        delay(1000); // 1 saniye bekle
        servoAngle = 90; // Orta pozisyona geri döndür
        myServo.write(servoAngle);
        Serial.println("Servo motor orta pozisyona geri döndü.");
    }
}
...
if (doc.containsKey("steerright")) {
    ...
    if (steerRight == 1) {
        // Servo motoru sağa 90 derece döndür ve sonra geri getir
